...
you should place your code here."
  ...
  (with-eval-after-load 'org
    (setq org-todo-keywords
          '((sequence "TODO" "PROGRESS" "BLOCKED" "REVIEW" "|" "DONE" "CANCELLED"))))
  (with-eval-after-load 'org
  ...
  (add-hook 'org-mode-hook (lambda () (hl-todo-mode)))
)
